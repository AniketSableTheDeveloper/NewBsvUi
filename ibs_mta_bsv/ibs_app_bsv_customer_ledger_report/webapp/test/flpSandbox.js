		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#comibsbsvibsappbsvcustomerledgerreport-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comibsbsvibsappbsvcustomerledgerreport-display": {
								"semanticObject": "comibsbsvibsappbsvcustomerledgerreport",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.ibs.bsv.ibsappbsvcustomerledgerreport",
									"url": sap.ui.require.toUrl("com/ibs/bsv/ibsappbsvcustomerledgerreport")
								}
							}
						}
					}
