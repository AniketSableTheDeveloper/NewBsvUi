		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "GRN",
									"targetURL": "#comibsbsvibsappbsvgrn-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comibsbsvibsappbsvgrn-display": {
								"semanticObject": "comibsbsvibsappbsvgrn",
								"action": "display",
								"description": "GRN",
								"title": "GRN",
								"signature": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.ibs.bsv.ibsappbsvgrn",
									"url": sap.ui.require.toUrl("com/ibs/bsv/ibsappbsvgrn")
								}
							}
						}
					}
