		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#comibsbsvibsappbsvschemecreation-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comibsbsvibsappbsvschemecreation-display": {
								"semanticObject": "comibsbsvibsappbsvschemecreation",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.ibs.bsv.ibsappbsvschemecreation",
									"url": sap.ui.require.toUrl("com/ibs/bsv/ibsappbsvschemecreation")
								}
							}
						}
					}
