		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#comibsbsvibsappbsvpoapproval-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comibsbsvibsappbsvpoapproval-display": {
								"semanticObject": "comibsbsvibsappbsvpoapproval",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.ibs.bsv.ibsappbsvpoapproval",
									"url": sap.ui.require.toUrl("com/ibs/bsv/ibsappbsvpoapproval")
								}
							}
						}
					}
