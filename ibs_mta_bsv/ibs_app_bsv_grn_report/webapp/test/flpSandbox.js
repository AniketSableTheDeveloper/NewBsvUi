		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "GRN Report",
									"targetURL": "#comibsbsvibsappbsvgrnreport-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comibsbsvibsappbsvgrnreport-display": {
								"semanticObject": "comibsbsvibsappbsvgrnreport",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.ibs.bsv.ibsappbsvgrnreport",
									"url": sap.ui.require.toUrl("com/ibs/bsv/ibsappbsvgrnreport")
								}
							}
						}
					}
