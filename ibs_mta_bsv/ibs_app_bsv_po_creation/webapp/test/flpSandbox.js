		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#comibsbsvibsappbsvpocreation-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comibsbsvibsappbsvpocreation-display": {
								"semanticObject": "comibsbsvibsappbsvpocreation",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.ibs.bsv.ibsappbsvpocreation",
									"url": sap.ui.require.toUrl("com/ibs/bsv/ibsappbsvpocreation")
								}
							}
						}
					}
