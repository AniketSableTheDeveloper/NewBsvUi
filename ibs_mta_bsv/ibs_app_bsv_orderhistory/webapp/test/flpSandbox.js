		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Order History",
									"targetURL": "#comibsbsvibsappbsvorderhistory-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comibsbsvibsappbsvorderhistory-display": {
								"semanticObject": "comibsbsvibsappbsvorderhistory",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.ibs.bsv.ibsappbsvorderhistory",
									"url": sap.ui.require.toUrl("com/ibs/bsv/ibsappbsvorderhistory")
								}
							}
						}
					}
