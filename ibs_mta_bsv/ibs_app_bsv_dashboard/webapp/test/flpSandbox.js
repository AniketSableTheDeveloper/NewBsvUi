		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Dashboard",
									"targetURL": "#comibsbsvibsappbsvdashboard-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comibsbsvibsappbsvdashboard-display": {
								"semanticObject": "comibsbsvibsappbsvdashboard",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.ibs.bsv.ibsappbsvdashboard",
									"url": sap.ui.require.toUrl("com/ibs/bsv/ibsappbsvdashboard")
								}
							}
						}
					}
