		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#comibsbsvibsappbsvorderstatus-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comibsbsvibsappbsvorderstatus-display": {
								"semanticObject": "comibsbsvibsappbsvorderstatus",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.ibs.bsv.ibsappbsvorderstatus",
									"url": sap.ui.require.toUrl("com/ibs/bsv/ibsappbsvorderstatus")
								}
							}
						}
					}
