		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Stock",
									"targetURL": "#comibsbsvibsappbsvstockdetails-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comibsbsvibsappbsvstockdetails-display": {
								"semanticObject": "comibsbsvibsappbsvstockdetails",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.ibs.bsv.ibsappbsvstockdetails",
									"url": sap.ui.require.toUrl("com/ibs/bsv/ibsappbsvstockdetails")
								}
							}
						}
					}
